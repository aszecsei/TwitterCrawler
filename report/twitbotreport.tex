...
As described by Bessi and Ferrera\cite{Bessi:PresElect}, we retrieve the most important descriptors of bots: whether they're using the default appearance, their retweet-to-tweet ratio, and others, in addition to the \emph{BotOrNot} score.
...
After discovering a number of inconsistencies 
...
[TODO: Talk about how we didn't get the expanded links from the tweets and how analysis might benefit, since media are naively represented as URLs in the raw tweet data]
