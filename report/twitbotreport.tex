...
Twitter bots are often cited as affecting the political process by manipulating
the trending topics data; similar behavior is also cited on platforms like Facebook.
We attempt to classify users as bots based on statistical analysis of their accounts,
and then examine the ways in which they interact with other users.
\end{abstract}

% We no longer use \terms command
%\terms{Theory}

\keywords{twitter; bot detection}
